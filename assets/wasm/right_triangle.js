...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_e9831d7aaaddda1a10abb2800d02102bed086f77": function($0) {
                Module.STDWEB.from_js($0, (function(){document.getElementById ("error"). style = "display: none;"})());
            },
            "__extjs_c4140967b0d9e39631c26549f9a455a12baa6373": function($0) {
                Module.STDWEB.from_js($0, (function(){document.getElementById ("error"). style = "display: block;"})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.right_triangle.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "../../../../assets/wasm/right_triangle.wasm" );
        ...
        const __promise = fetch( "../../../../assets/wasm/right_triangle.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'right_triangle'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'right_triangle':", error );
                throw error;
            });

        Rust.right_triangle = __promise;
        return __promise;
    }
}));
